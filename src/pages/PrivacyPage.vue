...
<template>
  <main>
    <div class="privacy">
      <h1>隱私權保護政策</h1>
      <p>
        非常歡迎您光臨「Healro網站」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
      </p>
      ...
      <p>如何關閉 Cookie？</p>
      <p>
        瀏覽器允許您更改 Cookie 的設定。這些設定可以在您的瀏覽器選單上的「選項」或
        「設定」找到。以下是一些參考連結：
      </p>
      <ul>
        <li>
          <a target="_blank" href="https://support.google.com/chrome/answer/95647"
            >Chrome™ 的 Cookie 設定</a
          >
        </li>
        <li>
          <a
            target="_blank"
            href="https://support.mozilla.org/zh-TW/kb/enable-and-disable-cookies-website-preferences"
            >Firefox® 的 Cookie 設定</a
          >
        </li>
        <li>
          <a
        ...
        <li>
          <a target="_blank" href="https://support.apple.com/zh-tw/guide/safari/sfri11471/mac"
            >Safari® 的 Cookie 設定</a
          >
        </li>
      </ul>
